...
import math 
#Objects - create the legs and the body of the robot and send them to the simulator 
#Joints - create joints between the body and upper legs; upper legs and lower legs 
class BODY:
    
    #WTS = genome #fleetNum 1=A, 2=B, 3=C
    def __init__(self, sim, fleetNum, wts):
        ...
        #Check we are dealing with fleet A or B
        #if so create the standard 4 legged robot - can be seen on r/ludobots
        ...
        #collisions with selfd for case of third robot
    ...
    def send_objects(self, sim, xLoc, yLoc):
        ...
        #create a set which contains the objects/limbs
        #Used by Brain to reference Objects
        self.O = {}
        self.O[0] = O0
        self.O[1] = O1
        self.O[2] = O2
    ...
    def send_joints(self, sim, xLoc, yLoc):
        ...
        J7 = sim.send_hinge_joint(first_body_id=self.O[4], second_body_id=self.O[8], x=2*c.L*self.coorX3, y=2*c.L*self.coorY3,
                                  z=c.L + c.R, n1=0, n2=-1, n3=0, lo=-3.14159 / 2, hi=3.14159 / 2)
        #Set that contains the joints
        #used by Brain to reference joints
        self.J = {}
        self.J[0] = J0
        self.J[1] = J1
        self.J[2] = J2
